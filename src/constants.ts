type LOCAL_STORAGE_KEYS = 'markdown' | 'pull_branch_name' | 'pull_title' | 'pull_url';
...
const LOCAL_STORAGE_KEY_MARKDOWN: LOCAL_STORAGE_KEYS = 'markdown';
const LOCAL_STORAGE_KEY_PULL_BRANCH_NAME: LOCAL_STORAGE_KEYS = 'pull_branch_name';
const LOCAL_STORAGE_KEY_PULL_TITLE: LOCAL_STORAGE_KEYS = 'pull_title';
const LOCAL_STORAGE_KEY_PULL_URL: LOCAL_STORAGE_KEYS = 'pull_url';
